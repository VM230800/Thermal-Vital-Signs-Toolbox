...
# ── Load sample (alter Weg, für 50 Frames OK) ──
sample = dataset[0]
    ...
    if gt_pulse is not None and len(gt_pulse) > 10:
        ...
        try:
            ...
            save_signal_comparison(
                ...
                fps=fps,
                predicted_bpm=r1["hr_bpm"],
                gt_bpm=gt_hr,
                signal_type="hr",
                method_name="thermal_mean",
                recording_id=recording_id,
                save_dir="results/",
                bandpass=(bp["low"], bp["high"]),
            )
        except Exception as e:
            print(f"    HR plot failed: {e}")
